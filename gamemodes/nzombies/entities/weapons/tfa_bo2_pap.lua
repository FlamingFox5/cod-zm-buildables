...
SWEP.BuildableMaxHealth = nil

--[NZombies]--
SWEP.NZWonderWeapon = false
SWEP.NZSpecialCategory = "shield"
SWEP.NZSpecialWeaponData = {MaxAmmo = 0, AmmoType = ""}
...
function SWEP:PostSpawnProjectile(ent)
	...
	if nzElec:IsOn() and ent.TurnOn then
		ent:TurnOn()
	end
	...
	ent.OnUsed = function(self, ply)
		...
		if self.GetBeingUsed and self:GetBeingUsed() then return end
