...
SWEP.Purpose = "#tfa.weaponinfo.miscbuild.useturbine.desc"
SWEP.Author = "FlamingFox"
SWEP.Slot = 0
SWEP.PrintName = nzombies and "Electric Trap | BO2" or "Electric Trap"
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo2/etrap/w_etrap.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_bo2/etrap/w_etrap.mdl"
SWEP.HoldType = "slam"
...
--[Projectile]--
SWEP.Primary.Projectile         = "bo2_trap_etrap"
SWEP.Primary.ProjectileVelocity = 0
SWEP.Primary.ProjectileModel    = "models/weapons/tfa_bo2/etrap/w_etrap.mdl"
...
SWEP.BuildableMaxBounds = Vector( 12.5, 30, 40 )
SWEP.BuildableMinBounds = Vector( -12.5, -30, 0 )
...
SWEP.NZHudIcon = Material("vgui/icon/zm_etrap_icon.png", "unlitgeneric smooth")
