...
SWEP.Slot = 0
SWEP.PrintName = nzombies and "Tramplesteam Trap | BO2" or "Tramplesteam Trap"
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo2/flinger/w_flinger.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_bo2/flinger/w_flinger.mdl"
SWEP.HoldType = "slam"
...
--[Projectile]--
SWEP.Primary.Projectile         = "bo2_trap_flinger"
SWEP.Primary.ProjectileVelocity = 0
SWEP.Primary.ProjectileModel    = "models/weapons/tfa_bo2/flinger/w_flinger.mdl"
...
SWEP.BuildableWallOffset = 42
SWEP.BuildableHeightOffset = 0

SWEP.BuildableMaxBounds = Vector(24, 30, 40)
SWEP.BuildableMinBounds = Vector(-41, -30, 0)
...
SWEP.NZHudIcon = Material("vgui/icon/zom_hud_trample_steam_complete.png", "unlitgeneric smooth")
