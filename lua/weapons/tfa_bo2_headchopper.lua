...
SWEP.Slot = 0
SWEP.PrintName = nzombies and "Head Chopper | BO2" or "Head Chopper"
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo2/headchopper/w_headchopper.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_bo2/headchopper/w_headchopper.mdl"
SWEP.HoldType = "slam"
...
--[Projectile]--
SWEP.Primary.Projectile         = "bo2_trap_headchopper"
SWEP.Primary.ProjectileVelocity = 0
SWEP.Primary.ProjectileModel    = "models/weapons/tfa_bo2/headchopper/w_headchopper.mdl"
...
SWEP.BuildableWallPlaceable = true
SWEP.BuildableWallReach = 80

--[NZombies]--
SWEP.NZWonderWeapon = false
SWEP.NZSpecialCategory = "trap"
SWEP.NZSpecialWeaponData = {MaxAmmo = 0, AmmoType = "none"}
SWEP.NZHudIcon = Material("vgui/icon/zom_hud_icon_buildable_chopper.png", "unlitgeneric smooth")
