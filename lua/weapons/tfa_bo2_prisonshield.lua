...
SWEP.Slot = 0
SWEP.PrintName = nzombies and "Prison Shield | BO2" or "Prison Shield"
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_bo2/prisonshield/c_prisonshield.mdl"
SWEP.ViewModelFOV = 70
SWEP.WorldModel			= "models/weapons/tfa_bo2/prisonshield/w_prisonshield.mdl"
...
SWEP.ShieldModel = "models/weapons/tfa_bo2/prisonshield/w_prisonshield_back.mdl"
...
SWEP.NZHudIcon = Material("vgui/icon/zm_riotshield_hellcatraz_icon.png", "unlitgeneric smooth")
...
{ ["time"] = 25 / 35, ["type"] = "sound", ["value"] = Sound("TFA_BO2_SHIELD.Key") },
},
[ACT_VM_HOLSTER] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("TFA_BO2_SHIELD.Recover") },
},
...
SWEP.BuildableHeightOffset = 27

SWEP.BuildableMaxBounds = Vector( 14, 14, 32 )
SWEP.BuildableMinBounds = Vector( -5, -14, -26.9 )
...
function SWEP:ThrowStart()
	...
	if mSetupData and !mSetupData["Valid"] then
		...
		if self.NotifyShieldMessage then
			self:NotifyShieldMessage()
		end
		return
	end
...
function SWEP:PlantShield()
	...
	ent:SetModel(self:GetWeaponWorldModel())
