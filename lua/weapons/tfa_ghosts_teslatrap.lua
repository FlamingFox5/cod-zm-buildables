...
SWEP.Author = "lilrobot, FlamingFox"
SWEP.Slot = 0
SWEP.PrintName = nzombies and "Tesla Trap | GHOST" or "Tesla Trap"
...
--[Model]--
SWEP.ViewModel			= "models/weapons/tfa_ghosts/teslatrap/w_teslatrap.mdl"
SWEP.ViewModelFOV = 65
SWEP.WorldModel			= "models/weapons/tfa_ghosts/teslatrap/w_teslatrap.mdl"
SWEP.HoldType = "slam"
...
--[Projectile]--
SWEP.Primary.Projectile         = "ghosts_trap_tesla"
SWEP.Primary.ProjectileVelocity = 0
SWEP.Primary.ProjectileModel    = "models/weapons/tfa_ghosts/teslatrap/w_teslatrap.mdl"

--[Stuff]--
SWEP.InspectPos = Vector(0, 0, -2)
SWEP.InspectAng = Vector(20, 0, 0)
...
SWEP.NZHudIcon = Material("vgui/icon/director_trap.png", "unlitgeneric smooth")
